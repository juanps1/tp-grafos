...
### 1. Configurar Neo4j
Neo4j ya está instalado y corriendo en: `http://localhost:7474`
- **Usuario:** neo4j
- **Contraseña:** password

### 2. Poblar la Base de Datos
**IMPORTANTE:** La base de datos necesita datos para que los algoritmos funcionen.

1. Abre Neo4j Browser: `http://localhost:7474`
2. Inicia sesión con usuario `neo4j` y contraseña `password`
...
5. Deberías ver: "Created 14 nodes, Created 13 relationships"
